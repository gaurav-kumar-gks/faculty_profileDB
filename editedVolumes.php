            ...
            <div class="col-md-12" style="width: 65rem;">
              ...
              ?>
                ...
                <div class="card">
                  ...
                  <div class="card-header">
                    <h4><i class='fa fa-edit'></i> Edit Your Edited Volumes </h4>
                  </div>
                  <br>
              ...
              ?>
                ...
                <div class="card">
                  ...
                  <!-- EDITED VOLUMES Fill FORM - BODY ends -->
                </div>
                <br>
                <!-- EDITED VOLUMES Fill FORM ends -->
              <?php
              } else { ?>
              ...
              <div class="card">
                <div class="card-header">
                  <form action="editedVolumes.php">
                    <h4><i class="fa fa-search mr-3"></i>Search by Paper Title</h4>
                    <div class="input-group">
                      <input type="text" name="CnameS" required class="form-control" placeholder="Search By Paper Title">
                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    if (strlen(Input::get('CnameS')) > 0) {
                      ...
                      // echo $roll;
                      $stmt = "SELECT fname,dept,title,authors, publisher, pdate, onlineLink, editedVolume FROM faculty_profile_publications WHERE ptype = 'ev' AND title LIKE '%$cname%' ORDER BY pdate DESC";
                      // echo $stmt;
                      $result = mysqli_query($conn, $stmt);
                      while ($row = mysqli_fetch_assoc($result)) {
                    ?>
              ...
              <!-- Search 1 - by ev title -->
              <div class="card">
                <div class="card-header">
                  <form action="editedVolumes.php">
                    <h4><i class="fa fa-search mr-3"></i>Search by Edited Volume Title</h4>
                    <div class="input-group">
                      <input type="text" name="CevnameS" required class="form-control" placeholder="Search By Edited Volume Title">
                      <input type="submit" name="CevnameSearch" class="btn btn-secondary">
                    </div>
                  </form>
                </div>
              </div>
                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    if (strlen(Input::get('CevnameS')) > 0) {
                      ...
                      // echo $roll;
                      $stmt = "SELECT fname,dept,title,authors, publisher, pdate, onlineLink, editedVolume FROM faculty_profile_publications WHERE ptype = 'ev' AND editedVolume LIKE '%$cevname%' ORDER BY pdate DESC";
                      // echo $stmt;
                      $result = mysqli_query($conn, $stmt);
                      while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    if (strlen(Input::get('CpnameS')) > 0) {
                      ...
                      // echo $roll;
                      $stmt = "SELECT fname,dept,title,authors, publisher, pdate, onlineLink, editedVolume FROM faculty_profile_publications WHERE ptype = 'ev' AND publisher LIKE '%$cpname%' ORDER BY pdate DESC";
                      // echo $stmt;
                      $result = mysqli_query($conn, $stmt);
                      while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    if (strlen(Input::get('CfnameS')) > 0) {
                      ...
                      // echo $roll;
                      $stmt = "SELECT fname,dept,title,authors, publisher, pdate, onlineLink, editedVolume FROM faculty_profile_publications WHERE ptype = 'ev' AND fname LIKE '%$cfname%' ORDER BY pdate DESC";
                      // echo $stmt;
                      $result = mysqli_query($conn, $stmt);
                      while ($row = mysqli_fetch_assoc($result)) {
                    ?>

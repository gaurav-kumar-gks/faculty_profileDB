...
if (Input::exists() && isset($_POST['delete_entry'])) {
  ...
  try {
    ...
    // delete query
    $stmt = "DELETE FROM `faculty_profile_publications` WHERE roll='$roll' AND ptype='ev' AND title=$ctitle AND authors=$cauthors AND publisher=$cpublisher AND pdate=$cyear AND editedVolume=$btitle;";
    //echo $stmt;
    // run delete query
    $result = mysqli_query($conn, $stmt);
  } catch (Exception $e) {
...
if (Input::exists() && isset($_POST['upgrade_entry_x'])) {
  ...
  try {
    ...
    $stmt = "select * from faculty_profile_publications where sno>$SNO and roll='$roll' and ptype='ev' order by sno asc limit 1";
    $result = mysqli_query($conn, $stmt);
    $count = 0;
    $val = 0;
...
if (Input::exists() && isset($_POST['edit'])) {
  try {
    ...
    // update query
    $stmt = "UPDATE `faculty_profile_publications` SET title='$ctitle', authors='$cauthors', publisher='$cpublisher', pdate='$cyear', onlineLink='$clink', editedVolume='$btitle' WHERE roll='$roll' AND ptype='ev' AND  title=$ctitlePrev AND authors=$cauthorsPrev AND publisher=$cpublisherPrev AND pdate=$cyearPrev AND onlineLink=$clinkPrev AND editedVolume=$btitlePrev;";
    //echo $stmt;
    // run query
    $result = mysqli_query($conn, $stmt);
  } catch (Exception $e) {
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12" style="width: 65rem;">
              ...
              ?>
                <!-- EDITED VOLUMES EDIT FORM -->
                <div class="card">
                  <!-- EDITED VOLUMES EDIT FORM - HEADER -->
                  <div class="card-header">
                    <h4><i class='fa fa-edit'></i> Edit Your Edited Volumes enteries</h4>
                  </div>
                  <br>
                  <!-- EDITED VOLUMES EDIT FORM - HEADER ends -->

                  <!-- EDITED VOLUMES EDIT FORM - BODY -->
                ...
                <br>
                <!-- EDITED VOLUMES EDIT FORM ends -->
              <?php
              } else { ?>
                <!-- EDITED VOLUMES INSERT FORM -->
                <div class="card">
                  <!-- EDITED VOLUMES INSERT FORM - HEADER -->
                  <div class="card-header">
                    <h4><i class='fa fa-edit'></i> Insert Edited Volumes </h4>
                  </div>
                  <br>
                  <!-- EDITED VOLUMES INSERT FORM - HEADER ends -->

                  <!-- EDITED VOLUMES INSERT FORM - BODY -->
                  <form action="editedVolumes.php" method="post">
                  ...
                  <!-- EDITED VOLUMES INSERT FORM - BODY ends -->
                </div>
                <br>
                <!-- EDITED VOLUMES INSERT FORM ends -->
              <?php } ?>
              <!-- EDITED VOLUMES EDIT/INSERT form ends -->

              <!-- VIEW ADDED EDITED VOLUMES -->
              <div class="card">
                <div class="card-header">
                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    // echo $roll;
                    $stmt = "SELECT * FROM faculty_profile_publications WHERE roll='$roll' AND ptype='ev' ORDER BY sno DESC;";
                    // echo $stmt;
                    $result = mysqli_query($conn, $stmt);
                    while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                      <tr>
                        ...
                        <td><?php echo $row['editedVolume']; ?></td>
              ...
              <div class="card">
                <div class="card-header">
                  <h4><i class="fa fa-search mr-3"></i> Search Edited Volumes </h4>
                </div>
                <br>
                <br>

                <!-- Search 0 - by book title -->
                <form action="editedVolumes.php">
                  <div class="input-group">
                    <input type="text" required name="BnameS" class="form-control" placeholder="Search By Edited Volume Title">
                ...
                <div class="table-responsive">
                  ...
                  if (strlen(Input::get('BnameS')) > 0) {
                    ...
                    $bnames->query("SELECT fname,dept,title,editedVolume,authors, publisher,CONCAT_WS('-', MONTH(pdate), YEAR(pdate)) AS day FROM faculty_profile_publications WHERE ptype = 'ev' AND editedVolume LIKE '%$bname%' ORDER BY pdate DESC");

                    if ($bnames->count()) {
                      echo "<table class=\"table table-striped table-hover\">";
                      echo "<thead class=\"thead-inverse\">";
                      echo "<tr><th>Name</th><th>Dept</th><th>Paper Title</th><th>Edited Volume</th><th>Authors</th><th>Publisher</th><th>Year</th></tr></thead>";
                      echo "<tbody>";

                      foreach ($bnames->results() as $row) {
                        echo "<tr><td>$row->fname</td><td>$row->dept</td><td>$row->title</td><td>$row->editedVolume</td><td>$row->authors</td><td>$row->publisher</td><td>$row->day</td></tr>\n";
                      }
                      echo "</tbody></table>";
                    }
                  }
                ...
                <form action="editedVolumes.php">
                  <div class="input-group">
                    <input type="text" required name="CnameS" class="form-control" placeholder="Search By Paper Title">
                ...
                <div class="table-responsive">
                  ...
                  if (strlen(Input::get('CnameS')) > 0) {
                    ...
                    $cnames->query("SELECT fname,dept,title,editedVolume,authors, publisher,CONCAT_WS('-', MONTH(pdate), YEAR(pdate)) AS day FROM faculty_profile_publications WHERE ptype = 'ev' AND title LIKE '%$cname%' ORDER BY pdate DESC");
                ...
                <div class="table-responsive">
                  ...
                  if (strlen(Input::get('CpnameS')) > 0) {
                    ...
                    $cpnames->query("SELECT fname,dept,title,editedVolume,authors, publisher,CONCAT_WS('-', MONTH(pdate), YEAR(pdate)) AS day FROM faculty_profile_publications WHERE ptype = 'ev' AND publisher LIKE '%$cpname%' ORDER BY pdate DESC");
                ...
                <div class="table-responsive">
                  ...
                  if (strlen(Input::get('cyearS') && is_numeric(Input::get('cyearS'))) > 0) {
                    ...
                    $cyears->query("SELECT fname,dept,title,editedVolume,authors, publisher, CONCAT_WS('-', MONTH(pdate), YEAR(pdate)) AS day FROM faculty_profile_publications WHERE ptype = 'ev' AND DATEDIFF(CURRENT_DATE, pdate)/365 < $cyear ORDER BY pdate DESC");
                ...
                <div class="table-responsive">
                  ...
                  if (strlen(Input::get('CfnameS')) > 0) {
                    ...
                    $cfnames->query("SELECT fname,dept,title,editedVolume,authors,  publisher,CONCAT_WS('-', MONTH(pdate), YEAR(pdate)) AS day FROM faculty_profile_publications WHERE ptype = 'ev' AND fname LIKE '%$cfname%' ORDER BY pdate DESC");

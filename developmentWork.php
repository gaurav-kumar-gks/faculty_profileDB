...
if (Input::exists() && isset($_POST['upgrade_entry_x'])) {
  ...
  try {
    ...
    $stmt = "select * from faculty_profile_research where rtype='dw' and sno>$SNO and roll='$roll' order by sno asc limit 1";
    $result = mysqli_query($conn, $stmt);
    $count = 0;
    $val = 0;
            ...
            <div class="col-md-12" style="width: 65rem;">
              ...
              ?>
                ...
                <div class="card">
                  ...
                  <div class="card-header">
                    <h4><i class='fa fa-edit'></i> Edit Your Development Works</h4>
                  </div>
                  <br>
              ...
              <?php
                ...
                <div class="card">
                  <!--  INSERT FORM - HEADER -->
                  <div class="card-header">
                    <h4><i class='fa fa-edit'></i> Insert Development Works</h4>
                  </div>
                  <br>
              ...
              <div class="card">
                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    // echo $roll;
                    $stmt = "SELECT * FROM faculty_profile_research WHERE roll='$roll' AND rtype='dw' ORDER BY sno DESC;";
                    // echo $stmt;
                    $result = mysqli_query($conn, $stmt);
                    while ($row = mysqli_fetch_assoc($result)) {
                    ?>
              ...
              <div class="card">
                <div class="card-header">
                  <h4><i class="fa fa-search mr-3"></i>Search Development Works</h4>
                </div>
                <br>
                <br>

                <!-- Search 1- by  name -->
                <form action="developmentWork.php">
                  <div class="input-group">
                    <input type="text" required name="CnameS" class="form-control" placeholder="Search By Work Title">
